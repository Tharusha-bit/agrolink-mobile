...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "signup.uploadHint": "Upload the Grama Sevaka letter before creating the account.",
    ...
    "signup.missingDetailsMessage": "Please complete the required fields first.",
    "signup.passwordMismatchTitle": "Password mismatch",
    "signup.passwordMismatchMessage": "Password and confirm password must match.",
    "signup.verificationRequiredTitle": "Verification required",
    "signup.verificationRequiredMessage": "Farmers must enter a farmer ID and upload the required document.",
    ...
    "signup.uploadFailedMessage": "Unable to pick the Grama Sevaka letter right now. Please try again.",
    ...
    "home.searchHintFarmer": "Use the dashboard to manage only your own investment requests.",
    "home.searchHintInvestor": "Use the dashboard to review and invest in active farmer requests.",
    "home.roleBannerFarmer": "Private farmer view: only your own requests appear on this home feed.",
    "home.roleBannerInvestor": "Investor marketplace: you are seeing active requests from multiple farmers.",
    ...
    "home.noPersonalRequestsText": "Farmers only see their own requests here. Create one from the dashboard.",
    "home.noFarmerRequestsText": "Investors can review multiple farmer requests here once they are created.",
    ...
    "dashboard.farmerSubtitle": "See the investors backing your farm and create investment requests that investors can review.",
    "dashboard.investorSubtitle": "See farmer investment requests, use AI before investing, and fund requests directly from this screen.",
    "dashboard.roleBannerFarmer": "Private farmer view: only your own requests are shown here.",
    "dashboard.roleBannerInvestor": "Investor marketplace: all live farmer requests are shown here.",
    ...
    "dashboard.farmerPanelText": "Use the existing dashboard to submit requests and track what investors have already funded, while keeping your connected investors visible below.",
    "dashboard.investorPanelText": "These live requests can be reviewed, checked with AI, and funded directly from the existing dashboard UI.",
    "dashboard.createInvestmentRequest": "Create Investment Request",
    "dashboard.createInvestmentRequestSubtitle": "Add a request so investors can review and fund it.",
    "dashboard.crop": "Crop",
    "dashboard.location": "Location",
    "dashboard.amountNeeded": "Amount needed",
    "dashboard.requestSummaryPlaceholder": "What will this investment be used for?",
    ...
    "dashboard.noInvestmentRequestsAvailable": "No investment requests available",
    "dashboard.noRequestsCreatedText": "Create your own investment request above. Only your requests appear in this view.",
    "dashboard.noInvestmentRequestsAvailableText": "Investor accounts can review and invest in all live farmer requests from here.",
    ...
    "dashboard.yourLiveInvestmentRequest": "This is your live investment request",
    ...
    "dashboard.aiConnectionIssue": "Connection issue prevented a fresh dummy assessment.",
    ...
    "dashboard.requestSentMessage": "Your investment request was submitted successfully and is now visible to investors.",
    "dashboard.chooseInvestmentAmount": "Choose Investment Amount",
    "dashboard.chooseInvestmentAmountText": "Enter how much you want to invest in this farmer request.",
    ...
    "dashboard.missingDetailsMessage": "Enter crop, location, amount, and summary before submitting the request.",
    ...
    "dashboard.invalidLocationMessage": "Location must be at least 2 characters.",
    "dashboard.invalidSummary": "Invalid summary",
    "dashboard.invalidSummaryMessage": "Summary must be at least 10 characters so investors can understand the request.",
    "dashboard.invalidAmount": "Invalid amount",
    "dashboard.invalidAmountMessage": "Enter an amount of at least LKR 1,000.",
    "dashboard.invalidRequestAmountMax": "Amount must be LKR 10,000,000 or less.",
    "dashboard.invalidInvestmentAmountMax": "Investment amount must be LKR 1,000,000 or less.",
    ...
    "dashboard.investmentRecordedMessage": "LKR {amount} has been added to this request.",
    ...
    "dashboard.deleteRequestMessage": "This will remove the request from the active database and from the investor feed.",
    "dashboard.requestDeleted": "Request deleted",
    "dashboard.requestDeletedMessage": "The request was removed from your account and the shared database.",
    ...
    "profile.languageDescription": "Choose the app language. The visible app screens will update immediately.",
    "profile.paymentMethodsTitle": "Payment methods",
    "profile.paymentMethodsMessage": "Bank account management is available from Settings.",
    "profile.helpSupportTitle": "Help & Support",
    "profile.helpSupportMessage": "Contact support@agrolink.app for account or funding help.",
    "profile.termsTitle": "Terms & Conditions",
    "profile.termsMessage": "Legal and privacy details are available in the app documentation.",
    ...
    "profile.securitySubtitle": "Change your password to keep your account safe",
    ...
    "profile.securityRequirementsError": "Password does not meet all requirements",
    ...
    "profile.securityAgreeText": "My current password will no longer work after this change. I will need to use the new password to log in.",
    "profile.securityAgreeRequired": "You must acknowledge this change before continuing",
    "profile.securityUpdatedTitle": "Password Updated",
    "profile.securityUpdatedMessage": "Your new password is active. Please use it next time you log in.",
  ...
  si: {
    ...
    "signup.missingDetailsMessage": "අවශ්‍ය තොරතුරු පුරවා පසුව නැවත උත්සාහ කරන්න.",
    ...
    "signup.verificationRequiredMessage": "ගොවීන් ගොවි හැඳුනුම් අංකය ඇතුළත් කර අවශ්‍ය ලේඛනය උඩුගත කළ යුතුය.",
    ...
    "signup.uploadFailedMessage": "දැනට ග්‍රාම සේවක ලිපිය තෝරාගත නොහැක. කරුණාකර නැවත උත්සාහ කරන්න.",
    ...
    "home.searchHintFarmer": "ඔබගේම ආයෝජන ඉල්ලීම් කළමනාකරණය කිරීමට පාලක පුවරුව භාවිතා කරන්න.",
    "home.searchHintInvestor": "ක්‍රියාකාරී ගොවි ඉල්ලීම් සමාලෝචනය කර ආයෝජනය කිරීමට පාලක පුවරුව භාවිතා කරන්න.",
    "home.roleBannerFarmer": "පුද්ගලික ගොවි දසුන: මෙම මුල් පිටුවේ ඔබගේම ඉල්ලීම් පමණක් පෙනේ.",
    "home.roleBannerInvestor": "ආයෝජක වෙළඳපොළ: ඔබට ගොවීන් කිහිපදෙනෙකුගේ ක්‍රියාකාරී ඉල්ලීම් පෙනේ.",
    ...
    "home.noPersonalRequestsText": "ගොවීන්ට මෙහි පෙනෙන්නේ ඔවුන්ගේම ඉල්ලීම් පමණි. පාලක පුවරුවෙන් එකක් සාදන්න.",
    "home.noFarmerRequestsText": "ගොවීන් ඉල්ලීම් සාදන විට ආයෝජකයින්ට මෙහි ඒවා සමාලෝචනය කළ හැක.",
    ...
    "dashboard.farmerSubtitle": "ඔබගේ ගොවිපොළට සහාය දක්වන ආයෝජකයින් බලන්න සහ ආයෝජකයින් සමාලෝචනය කළ හැකි ඉල්ලීම් සාදන්න.",
    "dashboard.investorSubtitle": "ගොවි ආයෝජන ඉල්ලීම් බලන්න, ආයෝජනයට පෙර AI භාවිතා කරන්න, සහ සෘජුවම අරමුදල් සපයන්න.",
    "dashboard.roleBannerFarmer": "පුද්ගලික ගොවි දසුන: මෙහි ඔබගේම ඉල්ලීම් පමණක් පෙන්වයි.",
    "dashboard.roleBannerInvestor": "ආයෝජක වෙළඳපොළ: සියලුම ක්‍රියාකාරී ගොවි ඉල්ලීම් මෙහි පෙන්වයි.",
    ...
    "dashboard.farmerPanelText": "ආයෝජකයින් දැනටමත් අරමුදල් ලබා දී ඇති දේවල් නිරීක්ෂණය කරමින්, ඔබගේ ආයෝජන ඉල්ලීම් ඉදිරිපත් කිරීමට පාලක පුවරුව භාවිතා කරන්න.",
    "dashboard.investorPanelText": "මෙම ක්‍රියාකාරී ඉල්ලීම් සමාලෝචනය කර, AI සමඟ පරීක්ෂා කර, සෘජුවම අරමුදල් ලබා දිය හැක.",
    "dashboard.createInvestmentRequest": "ආයෝජන ඉල්ලීමක් සාදන්න",
    "dashboard.createInvestmentRequestSubtitle": "ආයෝජකයින් සමාලෝචනය කර අරමුදල් ලබා දීමට ඉල්ලීමක් එක් කරන්න.",
    "dashboard.crop": "බෝගය",
    "dashboard.location": "ස්ථානය",
    "dashboard.amountNeeded": "අවශ්‍ය මුදල",
    "dashboard.requestSummaryPlaceholder": "මෙම ආයෝජනය භාවිතා කරන්නේ කුමක් සඳහාද?",
    ...
    "dashboard.noRequestsCreatedText": "ඉහතින් ඔබගේම ආයෝජන ඉල්ලීමක් සාදන්න. මෙහි පෙනෙන්නේ ඔබගේම ඉල්ලීම් පමණි.",
    "dashboard.noInvestmentRequestsAvailableText": "ආයෝජක ගිණුම්වලට මෙහි සියලුම ක්‍රියාකාරී ගොවි ඉල්ලීම් සමාලෝචනය කර ආයෝජනය කළ හැක.",
    ...
    "dashboard.investorConnected": "ආයෝජකයා දැනටමත් ඔබගේ ගොවිපොළ සමඟ සම්බන්ධ වී ඇත",
    ...
    "dashboard.yourLiveInvestmentRequest": "මෙය ඔබගේ ක්‍රියාකාරී ආයෝජන ඉල්ලීමයි",
    ...
    "dashboard.aiConnectionIssue": "සම්බන්ධතා ගැටළුවක් නිසා නව AI ඇගයීමක් ලබා ගත නොහැකි විය.",
    ...
    "dashboard.requestSentMessage": "ඔබගේ ආයෝජන ඉල්ලීම සාර්ථකව යවා ඇති අතර දැන් ආයෝජකයින්ට පෙනේ.",
    "dashboard.chooseInvestmentAmount": "ආයෝජන මුදල තෝරන්න",
    "dashboard.chooseInvestmentAmountText": "මෙම ගොවි ඉල්ලීම සඳහා ඔබ ආයෝජනය කිරීමට කැමති මුදල ඇතුළත් කරන්න.",
    "dashboard.amountInLkr": "රුපියල් මුදල",
    "dashboard.confirmInvestment": "ආයෝජනය තහවුරු කරන්න",
    "dashboard.missingDetails": "තොරතුරු අඩුයි",
    "dashboard.missingDetailsMessage": "ඉල්ලීම යැවීමට පෙර බෝගය, ස්ථානය, මුදල සහ සාරාංශය ඇතුළත් කරන්න.",
    ...
    "dashboard.invalidSummaryMessage": "ආයෝජකයින්ට ඉල්ලීම තේරුම් ගැනීමට සාරාංශය අක්ෂර 10කට වඩා තිබිය යුතුය.",
    ...
    "dashboard.invalidInvestmentAmountMax": "ආයෝජන මුදල රු. 1,000,000ට අඩු විය යුතුය.",
    ...
    "dashboard.investmentRecordedMessage": "මෙම ඉල්ලීමට රු. {amount}ක් එක් කර ඇත.",
    ...
    "dashboard.deleteRequestMessage": "මෙය ක්‍රියාකාරී දත්ත ගබඩාවෙන් සහ ආයෝජක පෝෂණයෙන් ඉවත් කරයි.",
    "dashboard.requestDeleted": "ඉල්ලීම මකා දමන ලදී",
    "dashboard.requestDeletedMessage": "ඉල්ලීම ඔබගේ ගිණුමෙන් සහ හවුල් දත්ත ගබඩාවෙන් ඉවත් කර ඇත.",
    ...
    "profile.completeProfile": "විශ්වාසය වැඩි කිරීමට ඔබගේ පැතිකඩ සම්පූර්ණ කරන්න.",
    ...
    "profile.languageDescription": "යෙදුම් භාෂාව තෝරන්න. පෙනෙන තිර වහාම යාවත්කාලීන වේ.",
    "profile.paymentMethodsTitle": "ගෙවීම් ක්‍රම",
    "profile.paymentMethodsMessage": "බැංකු ගිණුම් කළමනාකරණය Settings තුළ තිබේ.",
    "profile.helpSupportTitle": "උදව් සහ සහාය",
    "profile.helpSupportMessage": "ගිණුම් හෝ අරමුදල් උදව් සඳහා support@agrolink.app අමතන්න.",
    ...
    "profile.securitySubtitle": "ඔබගේ ගිණුම ආරක්ෂිතව තබා ගැනීමට මුරපදය වෙනස් කරන්න",
    ...
    "profile.securityAgreeText": "මෙම වෙනසෙන් පසු මගේ වත්මන් මුරපදය ක්‍රියා නොකරනු ඇත. ඊළඟ වර ලොග් වීමට මට නව මුරපදය භාවිතා කිරීමට සිදු වේ.",
    "profile.securityAgreeRequired": "ඉදිරියට යාමට පෙර මෙම වෙනස ඔබ පිළිගත යුතුය",
    "profile.securityUpdatedTitle": "මුරපදය යාවත්කාලීන විය",
    "profile.securityUpdatedMessage": "ඔබගේ නව මුරපදය දැන් ක්‍රියාත්මකයි. ඊළඟ ලොග් වීමේදී එය භාවිතා කරන්න.",
    "profile.securityErrorTitle": "දෝෂය",
    "profile.securityErrorMessage": "යම් ගැටළුවක් සිදුවිය. කරුණාකර නැවත උත්සාහ කරන්න.",
    ...
    "profile.investorSupportSub": "නිතර අසන ප්‍රශ්න, සජීවී කතාබස්, ගැටළුවක් වාර්තා කරන්න",
  ...
  ta: {
    ...
    "login.enterCredentials": "தொடர உங்கள் மின்னஞ்சல் மற்றும் கடவுச்சொல்லை உள்ளிடவும்.",
    ...
    "signup.uploadHint": "கணக்கை உருவாக்கும் முன் கிராம சேவகர் கடிதத்தை பதிவேற்றவும்.",
    ...
    "signup.passwordMismatchMessage": "கடவுச்சொலும் உறுதிப்படுத்தும் கடவுச்சொலும் ஒன்றாக இருக்க வேண்டும்.",
    "signup.verificationRequiredTitle": "சரிபார்ப்பு தேவை",
    "signup.verificationRequiredMessage": "விவசாயிகள் விவசாயி அடையாள எண்ணை உள்ளிட்டு தேவையான ஆவணத்தை பதிவேற்ற வேண்டும்.",
    ...
    "signup.uploadFailedMessage": "இப்போது கிராம சேவகர் கடிதத்தை தேர்ந்தெடுக்க முடியவில்லை. தயவுசெய்து மீண்டும் முயற்சிக்கவும்.",
    ...
    "home.searchHintFarmer": "உங்கள் சொந்த முதலீட்டு கோரிக்கைகளை நிர்வகிக்க டாஷ்போர்டைப் பயன்படுத்தவும்.",
    "home.searchHintInvestor": "செயலில் உள்ள விவசாயி கோரிக்கைகளை மதிப்பாய்வு செய்து முதலீடு செய்ய டாஷ்போர்டைப் பயன்படுத்தவும்.",
    "home.roleBannerFarmer": "தனிப்பட்ட விவசாயி காட்சி: இந்த முகப்பில் உங்கள் கோரிக்கைகள் மட்டும் தோன்றும்.",
    "home.roleBannerInvestor": "முதலீட்டாளர் சந்தை: பல விவசாயிகளின் செயலில் உள்ள கோரிக்கைகளை நீங்கள் பார்க்கிறீர்கள்.",
    ...
    "home.noPersonalRequestsText": "விவசாயிகள் இங்கு தங்கள் சொந்த கோரிக்கைகளை மட்டுமே காண்பார்கள். டாஷ்போர்டில் ஒன்றை உருவாக்குங்கள்.",
    "home.noFarmerRequestsText": "விவசாயிகள் கோரிக்கைகளை உருவாக்கிய பிறகு முதலீட்டாளர்கள் அவற்றை இங்கே மதிப்பாய்வு செய்யலாம்.",
    ...
    "dashboard.farmerSubtitle": "உங்கள் பண்ணைக்கு ஆதரவளிக்கும் முதலீட்டாளர்களைப் பாருங்கள் மற்றும் அவர்கள் மதிப்பாய்வு செய்யக்கூடிய முதலீட்டு கோரிக்கைகளை உருவாக்குங்கள்.",
    "dashboard.investorSubtitle": "விவசாயி முதலீட்டு கோரிக்கைகளைப் பாருங்கள், முதலீட்டிற்கு முன் AI ஐப் பயன்படுத்துங்கள், மேலும் நேரடியாக நிதியளியுங்கள்.",
    "dashboard.roleBannerFarmer": "தனிப்பட்ட விவசாயி காட்சி: இங்கு உங்கள் சொந்த கோரிக்கைகள் மட்டுமே காட்டப்படும்.",
    "dashboard.roleBannerInvestor": "முதலீட்டாளர் சந்தை: அனைத்து செயலில் உள்ள விவசாயி கோரிக்கைகளும் இங்கே காட்டப்படும்.",
    ...
    "dashboard.farmerPanelText": "உங்கள் முதலீட்டு கோரிக்கைகளை சமர்ப்பித்து, முதலீட்டாளர்கள் ஏற்கனவே நிதியளித்தவற்றைப் பின்தொடர டாஷ்போர்டைப் பயன்படுத்துங்கள்.",
    "dashboard.investorPanelText": "இந்த நேரடி கோரிக்கைகளை மதிப்பாய்வு செய்யலாம், AI மூலம் பரிசீலிக்கலாம், மேலும் நேரடியாக நிதியளிக்கலாம்.",
    "dashboard.createInvestmentRequest": "முதலீட்டு கோரிக்கையை உருவாக்கு",
    "dashboard.createInvestmentRequestSubtitle": "முதலீட்டாளர்கள் மதிப்பாய்வு செய்து நிதியளிக்க ஒரு கோரிக்கையைச் சேர்க்கவும்.",
    "dashboard.crop": "பயிர்",
    "dashboard.location": "இடம்",
    "dashboard.amountNeeded": "தேவையான தொகை",
    "dashboard.requestSummaryPlaceholder": "இந்த முதலீடு எதற்காக பயன்படுத்தப்படும்?",
    ...
    "dashboard.noRequestsCreatedText": "மேலே உங்கள் சொந்த முதலீட்டு கோரிக்கையை உருவாக்குங்கள். இங்கு உங்கள் கோரிக்கைகள் மட்டுமே தோன்றும்.",
    "dashboard.noInvestmentRequestsAvailableText": "முதலீட்டாளர் கணக்குகள் இங்கிருந்து அனைத்து செயலில் உள்ள விவசாயி கோரிக்கைகளையும் மதிப்பாய்வு செய்து முதலீடு செய்யலாம்.",
    ...
    "dashboard.investorConnected": "இந்த முதலீட்டாளர் ஏற்கனவே உங்கள் பண்ணையுடன் இணைக்கப்பட்டுள்ளார்",
    ...
    "dashboard.yourLiveInvestmentRequest": "இது உங்கள் செயலில் உள்ள முதலீட்டு கோரிக்கை",
    ...
    "dashboard.aiTryAgain": "பின்னணி சேவை மீண்டும் கிடைக்கும் போது மறுபடியும் முயற்சிக்கவும்.",
    "dashboard.aiNoHistoricalRate": "முன்னைய விகிதத் தரவை ஏற்ற முடியவில்லை.",
    "dashboard.aiConnectionIssue": "இணைப்பு சிக்கலால் புதிய AI மதிப்பீடு பெற முடியவில்லை.",
    ...
    "dashboard.requestSentMessage": "உங்கள் முதலீட்டு கோரிக்கை வெற்றிகரமாக சமர்ப்பிக்கப்பட்டது, இப்போது அது முதலீட்டாளர்களுக்குப் புலப்படும்.",
    "dashboard.chooseInvestmentAmount": "முதலீட்டு தொகையைத் தேர்ந்தெடுக்கவும்",
    "dashboard.chooseInvestmentAmountText": "இந்த விவசாயி கோரிக்கையில் நீங்கள் முதலீடு செய்ய விரும்பும் தொகையை உள்ளிடவும்.",
    "dashboard.amountInLkr": "LKR தொகை",
    "dashboard.confirmInvestment": "முதலீட்டை உறுதிப்படுத்து",
    "dashboard.missingDetails": "தகவல் குறைவு",
    "dashboard.missingDetailsMessage": "கோரிக்கையை சமர்ப்பிப்பதற்கு முன் பயிர், இடம், தொகை மற்றும் சுருக்கத்தை உள்ளிடவும்.",
    "dashboard.invalidCrop": "தவறான பயிர்",
    "dashboard.invalidCropMessage": "பயிர் பெயர் குறைந்தது 2 எழுத்துகள் இருக்க வேண்டும்.",
    "dashboard.invalidLocation": "தவறான இடம்",
    "dashboard.invalidLocationMessage": "இடம் குறைந்தது 2 எழுத்துகள் இருக்க வேண்டும்.",
    "dashboard.invalidSummary": "தவறான சுருக்கம்",
    "dashboard.invalidSummaryMessage": "முதலீட்டாளர்கள் கோரிக்கையைப் புரிந்துகொள்ள சுருக்கம் குறைந்தது 10 எழுத்துகள் இருக்க வேண்டும்.",
    "dashboard.invalidAmount": "தவறான தொகை",
    "dashboard.invalidAmountMessage": "குறைந்தது LKR 1,000 ஐ உள்ளிடவும்.",
    "dashboard.invalidRequestAmountMax": "தொகை LKR 10,000,000 ஐ விட குறைவாக இருக்க வேண்டும்.",
    "dashboard.invalidInvestmentAmountMax": "முதலீட்டு தொகை LKR 1,000,000 ஐ விட குறைவாக இருக்க வேண்டும்.",
    ...
    "dashboard.investmentRecordedMessage": "இந்த கோரிக்கைக்கு LKR {amount} சேர்க்கப்பட்டது.",
    ...
    "dashboard.deleteRequestMessage": "இது செயல்பாட்டிலுள்ள தரவுத்தளத்திலும் முதலீட்டாளர் பட்டியலிலும் இருந்து நீக்கப்படும்.",
    "dashboard.requestDeleted": "கோரிக்கை நீக்கப்பட்டது",
    "dashboard.requestDeletedMessage": "கோரிக்கை உங்கள் கணக்கிலிருந்தும் பகிரப்பட்ட தரவுத்தளத்திலிருந்தும் நீக்கப்பட்டது.",
    ...
    "profile.completeProfile": "நம்பிக்கையை உயர்த்த உங்கள் சுயவிவரத்தை முழுமைப்படுத்துங்கள்.",
    ...
    "profile.languageDescription": "பயன்பாட்டு மொழியைத் தேர்ந்தெடுக்கவும். காட்சியளிக்கும் திரைகள் உடனடியாகப் புதுப்பிக்கப்படும்.",
    "profile.paymentMethodsTitle": "கட்டண முறைகள்",
    "profile.paymentMethodsMessage": "வங்கி கணக்கு மேலாண்மை Settings பகுதியில் கிடைக்கிறது.",
    "profile.helpSupportTitle": "உதவி & ஆதரவு",
    "profile.helpSupportMessage": "கணக்கு அல்லது நிதி உதவிக்காக support@agrolink.app ஐ தொடர்புகொள்ளுங்கள்.",
    "profile.termsTitle": "விதிமுறைகள் மற்றும் நிபந்தனைகள்",
    "profile.termsMessage": "சட்ட மற்றும் தனியுரிமை விவரங்கள் பயன்பாட்டு ஆவணங்களில் கிடைக்கின்றன.",
    ...
    "profile.editSaveSuccessMessage": "சுயவிவரம் வெற்றிகரமாக புதுப்பிக்கப்பட்டது!",
    ...
    "profile.securitySubtitle": "உங்கள் கணக்கை பாதுகாப்பாக வைத்திருக்க கடவுச்சொல்லை மாற்றுங்கள்",
    ...
    "profile.securityConfirmNewPassword": "புதிய கடவுச்சொல்லை உறுதிப்படுத்தவும்",
    ...
    "profile.securityRequirementsError": "கடவுச்சொல் அனைத்து தேவைகளையும் பூர்த்தி செய்யவில்லை",
    ...
    "profile.securityAgreeText": "இந்த மாற்றத்திற்குப் பிறகு எனது தற்போதைய கடவுச்சொல் வேலை செய்யாது. அடுத்த முறை உள்நுழைய நான் புதிய கடவுச்சொல்லைப் பயன்படுத்த வேண்டும்.",
    "profile.securityAgreeRequired": "தொடர்வதற்கு முன் இந்த மாற்றத்தை நீங்கள் ஒப்புக்கொள்ள வேண்டும்",
    "profile.securityUpdatedTitle": "கடவுச்சொல் புதுப்பிக்கப்பட்டது",
    "profile.securityUpdatedMessage": "உங்கள் புதிய கடவுச்சொல் இப்போது செயலில் உள்ளது. அடுத்த முறை உள்நுழையும் போது அதைப் பயன்படுத்தவும்.",
    "profile.securityErrorTitle": "பிழை",
    "profile.securityErrorMessage": "ஏதோ தவறு ஏற்பட்டது. தயவுசெய்து மீண்டும் முயற்சிக்கவும்.",
    ...
    "profile.investorPaymentSub": "வங்கி கணக்குகளைச் சேர்க்க அல்லது நிர்வகிக்கவும்",
    "profile.investorSupportSub": "அடிக்கடி கேட்கப்படும் கேள்விகள், நேரடி உரையாடல், சிக்கலை அறிவிக்கவும்",
