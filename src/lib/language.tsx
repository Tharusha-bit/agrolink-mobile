...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.securityBaselineTitle": "Security baseline",
    "settings.securityBaselineMessage":
      "Role-based session, local persistence, and backend-ready auth flow enabled.",
    "settings.locationTitle": "District Weather",
    "settings.locationDescription":
      "Choose your Sri Lankan province and district so weather and field conditions stay relevant to your area.",
    "settings.currentLocation": "Current location",
    "settings.province": "Province",
    "settings.district": "District",
    "settings.saveLocation": "Save district",
    "settings.locationSavedTitle": "Location saved",
    "settings.locationSavedMessage":
      "Live weather will now use {district}, {province}.",
    ...
    "weather.cold": "Cool conditions",
    "weather.thunder": "Thunderstorm risk",
    "weather.loading": "Loading live weather...",
    "weather.unavailable": "Live weather unavailable right now.",
  ...
  si: {
    ...
    "settings.securityBaselineTitle": "මූලික ආරක්ෂාව",
    "settings.securityBaselineMessage":
      "භූමිකා-පදනම් සැසිය, දේශීය සුරැකීම සහ backend සූදානම් පිවිසුම් ප්‍රවාහය සක්‍රීයයි.",
    "settings.locationTitle": "දිස්ත්‍රික් කාලගුණය",
    "settings.locationDescription":
      "ඔබගේ ශ්‍රී ලංකා පළාත සහ දිස්ත්‍රික්කය තෝරන්න, එවිට කාලගුණය සහ වගා තත්ත්වයන් ඔබගේ ප්‍රදේශයට ගැලපේ.",
    "settings.currentLocation": "වත්මන් ස්ථානය",
    "settings.province": "පළාත",
    "settings.district": "දිස්ත්‍රික්කය",
    "settings.saveLocation": "දිස්ත්‍රික්කය සුරකින්න",
    "settings.locationSavedTitle": "ස්ථානය සුරකින ලදී",
    "settings.locationSavedMessage":
      "දැන් සජීවී කාලගුණය {district}, {province} භාවිතා කරයි.",
    "weather.clear": "පැහැදිලි අහස",
    "weather.partlyCloudy": "අර්ධ වශයෙන් වලාකුළු සහිතයි",
    "weather.overcast": "සම්පූර්ණ වලාකුළු සහිතයි",
    "weather.fog": "මීදුම ඇත",
    "weather.drizzle": "සැහැල්ලු පිහිලි වැසි",
    "weather.rain": "වැසි අපේක්ෂා කෙරේ",
    "weather.cold": "සිසිල් තත්ත්වයන්",
    "weather.thunder": "අකුණු සහිත වැසි අවදානම",
    "weather.loading": "සජීවී කාලගුණය පූරණය වෙමින්...",
    "weather.unavailable": "දැනට සජීවී කාලගුණය නොලැබේ.",
  ...
  ta: {
    ...
    "settings.securityBaselineTitle": "பாதுகாப்பு அடித்தளம்",
    "settings.securityBaselineMessage":
      "பாத்திர அடிப்படையிலான அமர்வு, உள்ளூர் சேமிப்பு, மற்றும் backend-க்கு தயாரான உள்நுழைவு ஓட்டம் இயங்குகிறது.",
    "settings.locationTitle": "மாவட்ட வானிலை",
    "settings.locationDescription":
      "உங்கள் இலங்கை மாகாணத்தையும் மாவட்டத்தையும் தேர்ந்தெடுக்கவும். அதனால் வானிலையும் பண்ணை நிலைத் தகவல்களும் உங்கள் பகுதியில் பொருந்தும்.",
    "settings.currentLocation": "தற்போதைய இடம்",
    "settings.province": "மாகாணம்",
    "settings.district": "மாவட்டம்",
    "settings.saveLocation": "மாவட்டத்தைச் சேமி",
    "settings.locationSavedTitle": "இடம் சேமிக்கப்பட்டது",
    "settings.locationSavedMessage":
      "இனி நேரடி வானிலை {district}, {province} ஐ பயன்படுத்தும்.",
    "weather.clear": "தெளிவான வானம்",
    "weather.partlyCloudy": "பகுதி மேகமூட்டம்",
    "weather.overcast": "முழு மேகமூட்டம்",
    "weather.fog": "மூடுபனி",
    "weather.drizzle": "இலகு தூறல்",
    "weather.rain": "மழை வாய்ப்பு",
    "weather.cold": "குளிர்ந்த நிலை",
    "weather.thunder": "இடி மின்னல் அபாயம்",
    "weather.loading": "நேரடி வானிலை ஏற்றப்படுகிறது...",
    "weather.unavailable": "நேரடி வானிலை இப்போது கிடைக்கவில்லை.",
